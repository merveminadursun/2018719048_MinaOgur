(function (c) {
    ...
    function f() {
            ...
            c.fn[l] = function (s) {
                ...
                if (s !== b) {
                    ...
                    (m ? p : p.eq(0)).each(function (u, v) {
                        var t = h(v);
                        r += t ? (m ? t.getContent().replace(/<(?:"[^"]*"|'[^']*'|[^'">])*>/g, "") : t.getContent()) : o.apply(c(v), q)
                    });
                    return r
                }
            }
        ...
        j.attr = c.fn.attr;
        c.fn.attr = function (n, p) {
            var m = this;
            if ((!n) || (n !== "value") || (!g(m))) {
                if (p !== b) {
                    return j.attr.call(m, n, p)
                } else {
                    return j.attr.call(m, n)
                }
            }
            if (p !== b) {
                k.call(m.filter(":tinymce"), p);
                j.attr.call(m.not(":tinymce"), n, p);
                return m
            } else {
                var o = m[0], l = h(o);
                return l ? l.getContent() : j.attr.call(c(o), n, p)
            }
        }
    }
})(jQuery);